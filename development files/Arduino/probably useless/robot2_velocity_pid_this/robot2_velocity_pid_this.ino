...
const float REGRESSION_SLOPE_L = 0.2969;
const float REGRESSION_INTERCEPT_L = 8.4371;

const float REGRESSION_SLOPE_R = 0.2976;
const float REGRESSION_INTERCEPT_R = 5.5832;
...
const int MIN_EFFECTIVE_PWM_L = 75; // For Left Motor (adjust if needed for 9V)
const int MIN_EFFECTIVE_PWM_R = 75; // For Right Motor (adjust if needed for 9V)
